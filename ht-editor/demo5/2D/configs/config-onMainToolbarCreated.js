(function() {
    ...
    function addItemsForDisplay(editor) {
        ...
        initData = function(data) {
            data.setImage('custom/images/basic/node.json');
        };
        ...
        initData = function(data) {
            ...
            data.setImage('custom/images/basic/group.json');
            data.s({
                'label': ' '
            });
        };
        ...
        type = ht.SubGraph;
        initData = function(data) {
            data.setImage('custom/images/basic/subgraph.json');
        };
        mainToolbar.addItem(editor.createDisplayItem(id, toolTip, icon, type, initData));
        ...
        type = ht.Node;
        initData = function(data) {
            data.setImage('custom/images/basic/vProgressBar.json');
            data.a({
        ...
        type = ht.Node;
        initData = function(data) {
            data.setImage('custom/images/basic/hProgressBar.json');
            data.a({
                'pb.value.visible': false,
                'pb.fore.color': "#3399FF",
                'pb.background': "#38373B"
        ...
        type = ht.Node;
        initData = function(data) {
            data.setImage('custom/images/basic/table.json');
            data.a({
        ...
        initData = function(data) {
            var date = new Date();
            data.setImage('custom/images/basic/clock.json');
            data.a({
